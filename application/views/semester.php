    ...
    <div class="content">
       <div class="col-md-12">
        ...
        <div class="container-fluid form-add hidden" style="background-color:#ffffff;padding:15px;"> 
            <form action="<?php echo base_url("Semester/add_sem"); ?>" method="Post" accept-charset="utf-8">
                <input type="text" name="sem_name" placeholder="Enter Semester"  class="form-control"><br>
            ...
            <table class="table">
                ...
                <?php foreach ($sem as $key): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('Semester/deleteSemester/' . $key['id']); ?> ">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
