...
<div class="main-panel">
    ...
    <div class="content">
        ...
        <div class="container-fluid form-add hidden" style="background-color:#ffffff;padding:15px;">
            <form action="<?php echo base_url(); ?>material/uploadData" method="Post" accept-charset="utf-8"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="title"> Enter Material Title : </label>
                    <input type="text" name="title" placeholder="Enter Material Title" required  class="form-control">
                </div>
                <div class="form-group">
                    <label for="quiz_id"> Enter Material ID : </label>
                    <input type="text" name="materials_id" placeholder=" Enter Material ID" required class="form-control" required="required">
                </div>
                <div class="form-group">
