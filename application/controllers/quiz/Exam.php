...
class Exam extends CI_Controller {
    ...
    function get_exam() {
        ...
        $exam = $this->Exams->get_exam($subject, $lesson);
                    ...
                    <div class="card" style="background-color: #e9e9e9;">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <h3> <?php echo $value['quiz_code'] . ' - ' . $value['title']; ?></h3>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span class="pull-right"><a href="<?php echo base_url('quiz/exam/view/' . $value['id']); ?>"  class="btn btn-success">Start</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function view($id) {
        $data['exam_meta'] = $this->Exams->get_exam_data($id);
        $this->load->view('quiz/start-exam', $data);
    }
